...
// functions, all within the namespace coen79_lab8
//
...
namespace coen79_lab8
{
    ...
    template <class Item, class Sizetype>
    const node<Item>* list_locate(const node<Item>* head_ptr, Sizetype position);
    ...
    template <class Item, class Sizetype>
    void list_insert_at(node<Item>*& head_ptr, const Item& entry, Sizetype position);

    template <class Item, class Sizetype>
    Item list_remove_at(node<Item>*& head_ptr, Sizetype position);

    template <class Item, class Sizetype>
    node<Item>* list_copy_segment(node<Item>* head_ptr, Sizetype start, Sizetype finish);
}
...
// delete everything after the word iterator in the second line:
    ...
    {
        public:
            node_iterator(coen79_lab8::node<Item>* initial = NULL) 
                { current = initial; }
    ...
    {
        public:
            const_node_iterator(const coen79_lab8::node<Item>* initial = NULL)
                { current = initial; }
            ...
            bool operator !=(const const_node_iterator other) const
                { return current != other.current; }
        private:
            const coen79_lab8::node<Item>* current;
    };
